...
class SubcategoriesControllerTest < ActionController::TestCase
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post :create, subcategory: { category_id: @subcategory.category_id, description: @subcategory.description, name: @subcategory.name }
    end
  ...
  test "should update subcategory" do
    patch :update, id: @subcategory, subcategory: { category_id: @subcategory.category_id, description: @subcategory.description, name: @subcategory.name }
    assert_redirected_to subcategory_path(assigns(:subcategory))
  end
