...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { description: @rate.description, image_name: @rate.image_name, title: @rate.title }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { description: @rate.description, image_name: @rate.image_name, title: @rate.title }
    assert_redirected_to rate_path(assigns(:rate))
  end
