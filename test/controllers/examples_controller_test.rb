...
class ExamplesControllerTest < ActionController::TestCase
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post :create, example: { enabled: @example.enabled, name: @example.name, subcategory_id: @example.subcategory_id }
    end
  ...
  test "should update example" do
    patch :update, id: @example, example: { enabled: @example.enabled, name: @example.name, subcategory_id: @example.subcategory_id }
    assert_redirected_to example_path(assigns(:example))
  end
